                  ...
                  ListView(children: [
                    ...
                    Card(
                        child: Column(children: [
                          ListTile(
                              title: Text(
                                  'Разновидности игры', style: TextStyle(
                                  fontWeight: FontWeight.bold)),
                              subtitle: Text(
                                  'Игра может происходить в двух форматах: парном и личном.',
                                  style: TextStyle(color: Colors.black))),
                          ListTile(
                              title: Text('А. Парная игра', style: TextStyle(
                                  fontWeight: FontWeight.bold)),
                              subtitle: Text(
                                  ...
                                  style: TextStyle(color: Colors.black))),
                          ListTile(
                              title: Text('B. Личная игра', style: TextStyle(
                                  fontWeight: FontWeight.bold)),
                              subtitle: Text(
                                  'При игре в личном зачёте каждый игрок объясняет слова разным игрокам. За каждое загаданное и за каждое отгаданное слово игрок получает по очку. Оптимальная схема для личной игры — когда каждый загадывает слова каждому по одному разу. Каждый круг все игроки загадывают слова тому, кто сидит за столом относительно них в определённом положении. Например, в первый круг все загадывают слова соседу слева, во второй круг — игроку через одного слева, и т.д.',
                                  style: TextStyle(color: Colors.black)))
                        ])),
                    Card(
                        child: Column(children: [
                          ListTile(
                            title: Text('Частности', style: TextStyle(
                                fontWeight: FontWeight.bold)),
                            subtitle: Text(
